          ...
          <div className="userInfo">
            ...
            <div className='profileSettings'>
              <button onClick={() => setNav(false)} className='py-2 px-3 m-auto text-center font-bold'>
                <Link to={`/freelancer/settings/${userId}`} className='buttonSettings text-white bg-[#1D5B79]'>Manage Profile</Link>
              </button>
              <button onClick={() => setNav(false)} className='py-2 px-3 m-auto text-center font-bold'>
                <Link to={`/freelancert/billing/${userId}`} className='buttonSettings text-[#1D5B79] bg-[#F5F5DC]'>Portfolio</Link>
              </button>
            </div>
          </div>
