...
import FConnect from "./FConnect.jsx";
    ...
    <Card className="mt-6 min-w-sm max-w-96 max-h-[30rem] pt-6">
      <CardBody className="flex flex-col justify-between items-start h-full">
        <div className="flex flex-col">
          ...
          <Typography className="text-gray-400 mt-5">{details}</Typography>
        </div>
      ...
      <CardFooter>
        <div className="align-bottom w-full flex justify-center">
          <Button
            ...
            className="w-full h-10 p-2 text-center bg-orange-600 rounded-md hover:bg-[#1D5B79] active:bg-blue-800"
          >
            {button}
          </Button>
        </div>
...
export default WithAuth(FCards);
