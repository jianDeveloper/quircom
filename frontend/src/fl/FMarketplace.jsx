...
import FCards from "./FMarketComponents/FCards";
        ...
        <div className="flex-col mx-10 my-10 w-full">
          ...
          >
            <div className="absolute bottom-10 left-10 text-white p-2">
              <h1 className="text-[50px] font-bold mb-5">Commissions</h1>
            </div>
          </div>
...
export default WithAuth(FMarketplace);
