...
function CRank() {
  return (
    ...
    <div class="relative flex flex-col w-full min-w-0 mb-0 break-words bg-beige border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
        <div>
        <NavHeader />
      </div>
