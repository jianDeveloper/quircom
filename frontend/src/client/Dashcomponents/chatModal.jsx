...
const chatModal = ({ setchatModal }) => {
  ...
  return (
    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none shadow-md">
      <div className="opacity-25 fixed inset-0 z-40 bg-black"></div> {/* Overlay */}
      <div className="relative w-1/3 my-6 mx-auto z-50"> {/* Modal window */}
        <div className="border-0 rounded-lg relative flex flex-col w-full bg-white shadow-lg">
          ...
          <div className="bg-red-500 text-white rounded-b-md">
            <button className="w-full" onClick={() => setchatModal(false)}>close</button>
          </div>
        </div>
      </div>
    </div>
