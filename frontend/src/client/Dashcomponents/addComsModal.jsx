...
const AddComsModal = ({ setaddModal }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.serviceType) {
      errors.serviceType = "Please select a commission type";
    }
    ...
    try {
      ...
      if (response && response.data) {
        ...
        toast.success("Commission uploaded successfully", {
          autoClose: 2000,
          onClose: () => {
            setTimeout(() => {
              setaddModal(false);
        ...
        toast.error("Failed to upload Commission");
      }
    } catch (error) {
      toast.error("Failed to upload Commission");
    }
...
export default WithAuth(AddComsModal);
