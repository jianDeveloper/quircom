                ...
                return (
                  <tr key={rowIndex} className="border-b">
                    ...
                    <td className="px-6 py-4 text-left">
                      ...
                      {detailsModal ? <CdetailsModal setdetailsModal={setdetailsModal} /> : null}
                      <button
                        type="button"
                      ...
                      {chatModal ? <CchatModal setchatModal={setchatModal} /> : null}
                      <button
                        type="button"
                      ...
                      {filesModal ? <CfilesModal setfilesModal={setfilesModal} /> : null}
