  ...
  <div class="container mx-auto px-4">
    <nav class="flex">
      <ol role="list" class="flex items-center">
        <li class="text-left">
          <div class="-m-1">
            <a href="#" class="rounded-md p-1 text-sm font-medium text-black-600 focus:text-gray-900 focus:shadow hover:bg-[#EA580C]"> Home </a>
          </div>
        </li>
        ...
        <li class="text-left">
          <div class="flex items-center">
            ...
            <div class="-m-1">
              <a href="#" class="rounded-md p-1 text-sm font-medium text-black-600 focus:text-gray-900 focus:shadow hover:bg-[#EA580C]"> Service </a>
            </div>
          </div>
        </li>
        ...
        <li class="text-left">
          <div class="flex items-center">
            <span class="mx-2 text-black-400">/</span>
            <div class="-m-1">
              <a href="#" class="rounded-md p-1 text-sm font-medium text-black-600 focus:text-gray-900 focus:shadow hover:bg-[#EA580C]" aria-current="page"> Settings </a>
            </div>
          </div>
        </li>
      </ol>
