            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg text-white hover:scale-105 duration-300 bg-gradient-to-r from-cyan-900 to-sky-800'>
                    ...
                    <Link to="/client/billing">
                        <button className='ml-[130px] bg-w-[600px] bg-gradient-to-r from-red-500 to-orange-500 rounded-md font-medium my-6 mx-auto p-3'>Free Plan</button>
                    </Link>
                </div>
                ...
                <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-lg text-white hover:scale-105 duration-300 bg-gradient-to-r from-cyan-900 to-sky-800'>
                    ...
                    <Link to="/client/billing">
                    <button className='ml-[110px] bg-w-[600px] bg-gradient-to-r from-red-500 to-orange-500 rounded-md font-medium my-6 mx-auto p-3'>Premium Plan</button>
                    </Link>
                </div>
            </div>
        </div>
