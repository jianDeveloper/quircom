          ...
          <div className="grid grid-cols-8 pt-3 sm:grid-cols-10">
            ...
            <div className="col-span-8 overflow-hidden rounded-xl sm:bg-[#F7F6DF] sm:px-8 sm:shadow">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <p className="text-gray-600">Your account is <strong>John Doe</strong></p>
              </div>
              <hr className="mt-4 mb-8" />
              {/* PORTFOLIO ZONE */}
              <p className="py-2 text-xl font-semibold">Portfolio</p>
              ...
              <button className="mt-4 rounded-lg bg-[#FE6D30] hover:bg-[#1D5B79] active:bg-blue-800 px-4 py-2 text-white">Save Portfolio</button>
              <hr className="mt-4 mb-8" />
