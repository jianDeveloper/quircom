    ...
    return (
        <div className='w-full py-[10rem] px-4 mt-2'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-l-lg text-white hover:scale-110 duration-300 bg-gradient-to-r from-cyan-900 to-sky-800'>
                ...
                <div className='w-full shadow-xl flex flex-col p-4 md:my-0 my-4 rounded-lg text-white hover:scale-110 duration-300 bg-gradient-to-r from-cyan-900 to-sky-800'>
                    <img className='w-20 mx-auto mt-[-3rem]' src={QRM1} alt="" />
                ...
                <div className='w-full shadow-xl flex flex-col p-4 my-8 rounded-r-lg text-white hover:scale-110 duration-300 bg-gradient-to-r from-cyan-900 to-sky-800'>
                    <img className='w-20 mx-auto mt-[-3rem]' src={QRM1} alt="" />
