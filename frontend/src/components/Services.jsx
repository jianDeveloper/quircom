...
const Services = () => {
  return (
    <section id='services' className='w-full bg-[#F5F5DC] py-16 px-4'>
      <div className='max-w-[1240px] md:mx-auto grid md:grid-cols-2 mx-5'>
      ...
      <div className='grid md:grid-cols-3 gap-4 md:p-10 mt-[100px] h-96'>
            <div className='flex flex-col items-center min-h-60 justify-center m-3 px-4 px-2 rounded-[20px] bg-gradient-to-r from-red-500 to-orange-500 shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] hover:scale-105 duration-300'>
                <h4 className='font-bold text-[#F5F5DC] text-[30px] leading-[23px] text-center mb-5'>Freelancers Showcasing</h4>
