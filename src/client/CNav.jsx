  ...
  return (
    <aside className='flex items-center'>
      <div class={`hidden flex-col justify-center items-center float-left ${controller ? 'w-72': 'w-20'} h-[100vh] md:flex p-3 pt-5 bg-orange-600 relative `}>
        ...
        <ul className='my-10 py-2 rounded-xl bg-[#F5F5DC] w-full '>
        <Link to="/client/profile">
            <li className={`text-[#163646] p-4 my-4 font-medium flex items-center gap-x-4 cursor-pointer hover:bg-blue-100 rounded-md mt-2`}>
              <img src={userL} className='h-6 w-6 hover:rotate-[360deg] duration-500' />
          ...
          <Link to="/client/dashboard">
            <li className={`text-[#163646] p-4 my-4 font-medium flex items-center gap-x-4 cursor-pointer hover:bg-blue-100 rounded-md mt-12`}>
              <img src={dboardL} className='h-6 w-6 hover:rotate-[360deg] duration-500' />
          ...
          <Link to="/client/browse-service">
            <li className={`text-[#163646] p-4 my-4 font-medium flex items-center gap-x-4 cursor-pointer hover:bg-blue-100 rounded-md mt-2`}>
              <img src={serviceL} className='h-6 w-6 hover:rotate-[360deg] duration-500' />
          ...
          <Link to="/client/tracker">
            <li className={`text-[#163646] p-4 my-4 font-medium flex items-center gap-x-4 cursor-pointer hover:bg-blue-100 rounded-md mt-2`}>
              <img src={trackerL} className='h-6 w-6 hover:rotate-[360deg] duration-500' />
          ...
          <Link to="/client/settings">
            <li className={`text-[#163646] p-4 my-4 font-medium flex items-center gap-x-4 cursor-pointer hover:bg-blue-100 rounded-md mt-12`}>
              <img src={settingsL} className='h-6 w-6 hover:rotate-[360deg] duration-500' />
